...
class CinemaController
{
    ...
    public function editCinema()
    {
        ...
        elseif (filter_input(INPUT_SERVER, 'REQUEST_METHOD') === "GET") {
            ...
            if ($sanEntries && $sanEntries['cinemaID'] !== null && $sanEntries['cinemaID'] !==
                ...
                $cinema = $this->cinema->getCinemaInformationsByID($sanEntries['cinemaID']);
            }
    ...
    public function deleteCinema()
    {
        ...
        if (filter_input(INPUT_SERVER, 'REQUEST_METHOD') === "POST") {
            ...
            $this->cinema->deleteCinema($sanitizedEntries['cinemaID']);
        }
